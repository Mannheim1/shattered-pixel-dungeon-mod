...
public enum Talent {
	...
	DINNER_SHOW(1000), PERFECT_PITCH(1001), ACCENTED_STRIKE(1002), CLOSING_CHORD(1003),
	//Bard T2
	MUSICIANS_MEAL(1004), LIQUID_CADENZA(1005), REVERB(1006), ECHOLOCATION(1007), SIGHT_READING(1008),
	//Bard T3
	...
	public static void initClassTalents( HeroClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents, LinkedHashMap<Talent, Talent> replacements ){
		...
		switch (cls){
			...
			case CLERIC:
				...
				break;
			case BARD:
				Collections.addAll(tierTalents, ENCORE, TRAVELING_MUSICIAN);
				break;
		}
		for (Talent talent : tierTalents){
			if (replacements.containsKey(talent)){
