...
//dummy song for testing song acquisition, does nothing when cast
public class PlaceholderSongA extends Song {

	public static final PlaceholderSongA INSTANCE = new PlaceholderSongA();
	...
	public void onCast(Lute lute, Hero hero) {
		GLog.i(Messages.get(this, "cast_msg"));
	}
